...
cs_pin0 = digitalio.DigitalInOut(board.CE0)
dc_pin0 = digitalio.DigitalInOut(board.D23)
reset_pin0 = digitalio.DigitalInOut(board.D22)
cs_pin1 = digitalio.DigitalInOut(board.CE1)
dc_pin1 = digitalio.DigitalInOut(board.D25)
reset_pin1 = digitalio.DigitalInOut(board.D24)
...
if disp1.rotation % 180 == 90:
    height = disp1.width  # we swap height/width to rotate it to landscape!
    width = disp1.height
else:
    width = disp1.width  # we swap height/width to rotate it to landscape!
    height = disp1.height
...
# Draw a smaller inner purple rectangle
draw.rectangle((BORDER, BORDER, width - BORDER - 1, height - BORDER - 1), fill=(255, 255, 0))
